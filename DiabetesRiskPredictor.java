 ...
 * Demonstrates: Runtime polymorphism (RiskCalculator reference),
 *               Collections via PatientRecord, File I/O on save
 */
public class DiabetesRiskPredictor extends JFrame {
    ...
    private JPanel buildSidebar() {
        ...
        JLabel appSub = new JLabel("Predictor");
        ...
        JTextArea disc = sidebarText(
            "⚠ This tool provides estimates only. It is NOT a substitute " +
    ...
    private void predict() {
        ...
        // Runtime polymorphism — calculator is a RiskCalculator reference
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(DiabetesRiskPredictor::new);
    }
}
