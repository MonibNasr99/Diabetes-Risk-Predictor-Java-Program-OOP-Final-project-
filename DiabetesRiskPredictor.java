...
public class DiabetesRiskPredictor extends JFrame {
    ...
    public DiabetesRiskPredictor() {
        ...
        records.loadFromFile();   // restore any previously saved patient records from disk
    ...
    private JScrollPane buildMainPanel() {
        ...
        // page heading shown at the top of the main content area
    ...
    private void predict() {
        ...
        if (patient == null) return;                      // readFields already showed an error dialog, nothing more to do
